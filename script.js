...
function translateFile() {
    ...
    reader.onload = async(event) => {
        ...
        const plainText = await convertWordToPlainText(fileContent);
        ...
        translateTextForFile(plainText, (translatedText) => {
...
async function convertWordToPlainText(fileContent) {
    return new Promise((resolve, reject) => {
